...
@section('title', 'Adicionar Nova Conta')

@section('content_header')
    <h1 class="ion-person-add"> Adicionar Nova</h1>
@stop
...
<ol class="breadcrumb">
    ...
    <li class="active">ContasReceber</li>
</ol>
	        ...
	        <form role="form" action="{{ route('advogados.store') }}" method="POST">	        	
				...
				<h3 class="ion-clipboard" style="margin-left: 15px"> Dados Pessoais</h3>
	                ...
	                <div class="form-group col-md-6">
	                	...
	                	<input type="text" class="form-control input-sm" id="advogadoNome" name="nome" placeholder="digite seu nome...">
	                </div>

	                <div class="form-group col-md-3">
	                	<label for="oab">OAB</label>
	                	<input type="text" class="form-control input-sm" id="advogadoOab"  name="oab" placeholder="digite sua oab...">
	                </div>

	                <div class="form-group col-md-4">
	                	<label for="celular">Celular</label>
	                	<input type="text" class="form-control input-sm" id="advogadoCelular" name="celular" placeholder="digite seu celular...">
	                </div>

	                <div class="form-group col-md-4">
	                	<label for="telefone">Telefone</label>
	                	<input type="text" class="form-control input-sm" id="advogadoTelefone" name="telefone" placeholder="digite seu telefone...">
	                </div>

	                <div class="form-group col-md-4">
	                	<label for="email">E-mail</label>
	                	<input type="email" class="form-control input-sm" id="advogadoEmail" name="email" placeholder="digite seu e-mail...">
	                </div>
			</form>
        </div>
	</div>	
	        ...
	        <form role="form" action="{{ route('advogados.store') }}" method="POST">	        	
                ...
                <h3 class="ion-clipboard" style="margin-left: 15px"> Endereco</h3>
					...
					<div class="form-group col-md-12">
	                	...
	                	<textarea type="email" class="form-control input-sm" id="advogadoDescricao" name="descricao" placeholder="digite sua descricão..."></textarea>
	                </div>
     			 <div class="form-group" style="margin-left: 15px">	
     				<button type="submit" class="btn btn-success btn-sm"><b class="fa fa-paper-plane"></b> Salvar estagiario</button>
 					<a href="../estagiarios" class="btn btn-primary btn-sm"><b class="fa fa-reply-all"></b> Voltar à lista de estagiarios</a>
     			 </div>
			</form>
        </div>
	</div>	
