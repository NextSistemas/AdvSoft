...
@section('title', 'Lista de Varas/Foros')
...
<div class="box box-solid box-primary">
	...
	<div class="box-header">
        ...
        <h3 class="box-title">Lista de Varas/Foros</h3>
	...
	<div class="box-body">
		<!-- box-header -->
		<div class="box-header">
			<a href="varasForos/novo" class="btn btn-success btn-sm">
