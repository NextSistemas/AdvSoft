<?php $__env->startSection('title', 'Cadastrar Clientes'); ?>
			...
			<div class="row">
				...
				<div class="form-group col-md-2">
					<label for="situacao">Situação *</label>
						<select class="form-control input-sm" id="clienteSituacao" name="situacao">
                ...
                <div class="form-group col-md-3">
					...
					name="telefone" placeholder="digite a data de nascimento...">
	            </div>
			</div>
		</div>	
	</div>
		...
		<div class="box-body">
			<div class="row">
	            ...
	            <div class="form-group col-md-4">
	            	...
	            	<input type="text" class="form-control input-sm" id="advogadoNome" 
					name="nome" placeholder="digite um número do celular...">
	        	</div>

	            <div class="form-group col-md-4">
	            	<label for="oab">Telefone Residencial</label>
	            	<input type="text" class="form-control input-sm" id="estagiarioOab"  
					name="oab" placeholder="digite um número fixo...">
	            </div>
			</div>
		</div>	
	</div>
		...
		<div class="box-body">
			<div class="row">
				...
				<div class="form-group col-md-12">
					...
					name="descricao" placeholder="descreva uma observação..."></textarea>
	            </div>
