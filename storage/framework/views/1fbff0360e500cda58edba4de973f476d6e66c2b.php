<?php $__env->startSection('title', 'Lista de Instâncias'); ?>

<?php $__env->startSection('content_header'); ?>
    <h1 class="ion-ios-pricetags"> Lista de Instâncias</h1>
...
<!-- Tabela de lista de todas as instâncias cadastradas -->
<div class="box box-primary">
	<div class="box-header">
		<a href="instancias/criar" class="btn btn-success btn-sm"><i class="ion-person-add"></i> Adcionar Nova</a>
