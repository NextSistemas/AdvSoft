<?php $__env->startSection('title', 'Lista de Tribunais'); ?>

<?php $__env->startSection('content_header'); ?>
    <h1 class="ion-ios-pricetags"> Lista de Tribunais</h1>
...
<!-- Tabela de lista de todos os tribunais cadastrados -->
<div class="box box-primary">
	<div class="box-header">
		<a href="tribunais/criar" class="btn btn-success btn-sm"><i class="ion-person-add"></i> Adcionar Novo</a>
