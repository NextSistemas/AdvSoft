<?php $__env->startSection('title', 'Lista de Colaboradores'); ?>

<?php $__env->startSection('content_header'); ?>
    <h1 class="ion-ios-pricetags"> Lista de Colaboradores</h1>
...
<!-- Tabela de lista de todos os colaboradores cadastrados -->
<div class="box box-primary">
	<div class="box-header">
		<a href="colaboradores/criar" class="btn btn-success btn-sm"><i class="ion-person-add"></i> Adcionar Novo</a>
